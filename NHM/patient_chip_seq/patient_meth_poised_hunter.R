...
png("heatmap_melanoma_nevi_poised_in_hunter_233_genes.png",width= 2,
...
png("heatmap_melanoma_nevi_poised_in_hunter_233_genes_centered.png",width= 2,
  height= 3.25,units="in",
  res=1200,pointsize=4)
...
png("heatmap_melanoma_nevi_poised.png",width= 2,
  height= 3.25,units="in",
  res=1200,pointsize=4)
...
png("heatmap_melanoma_nevi_poised_centered.png",width= 2,
  height= 3.25,units="in",
  res=1200,pointsize=4)
heatmap.2(as.matrix(meth.norm.centered),col=colors,scale="none", 
          trace="none",distfun = function(x) get_dist(x,method="pearson"),srtCol=90,
