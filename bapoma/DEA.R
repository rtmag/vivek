...
saveRDS(vsd,"bapoma_vsd.rds")
##############################################################################################################
A = "Normal"
B = "Bapoma"
  # Volcano
  title= "norm_vs_bap_volcano.pdf"
  pdf(title)
...
# RankedListFor GSEA
  ...
  title= "norm_vs_bap_genes_ranked_table_FCFDR.rnk"
...
# Significant Results ordered by log2FC
  ...
  title= "norm_vs_bap_differentially_expressed_genes.csv"
