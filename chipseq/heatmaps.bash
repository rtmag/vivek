...
-m /root/vivek/chip-seq/heatmap/H3K27ac_NHM_BRAF_CDKN2A.mat \
 --samplesLabel "H3K27ac BRAF" "H3K27ac CDKN2A+BRAF" "H3K27ac CDKN2A" "H3K27ac NHM" \
-out /root/ong_dukenus/ATAC-SEQ/heatmap/H3K27ac_NHM_BRAF_CDKN2A.pdf

plotHeatmap --xAxisLabel "" --yAxisLabel "" --refPointLabel "TSS" --colorMap Oranges \
-m /root/vivek/chip-seq/heatmap/H3K27me3_NHM_BRAF_CDKN2A.mat \
 --samplesLabel "H3K27me3 BRAF" "H3K27me3 CDKN2A+BRAF" "H3K27me3 CDKN2A" "H3K27me3 NHM" \
-out /root/ong_dukenus/ATAC-SEQ/heatmap/H3K27me3_NHM_BRAF_CDKN2A.pdf

plotHeatmap --xAxisLabel "" --yAxisLabel "" --refPointLabel "TSS" --colorMap Greens \
-m /root/vivek/chip-seq/heatmap/H3K4me3_NHM_BRAF_CDKN2A.mat \
 --samplesLabel "H3K4me3 BRAF" "H3K4me3 CDKN2A+BRAF" "H3K4me3 CDKN2A" "H3K4me3 NHM" \
-out /root/ong_dukenus/ATAC-SEQ/heatmap/H3K4me3_NHM_BRAF_CDKN2A.pdf

plotHeatmap --xAxisLabel "" --yAxisLabel "" --refPointLabel "TSS" --colorMap Reds \
-m /root/vivek/chip-seq/heatmap/H3K9me3_NHM_BRAF_CDKN2A.mat \
 --samplesLabel "H3K9me3 BRAF" "H3K9me3 CDKN2A+BRAF" "H3K9me3 CDKN2A" "H3K9me3 NHM" \
-out /root/ong_dukenus/ATAC-SEQ/heatmap/H3K9me3_NHM_BRAF_CDKN2A.pdf
################################################################################################
plotHeatmap --xAxisLabel "" --yAxisLabel "" --refPointLabel "TSS" --colorMap Blues \
-m /root/vivek/chip-seq/heatmap/H3K27ac_NHM_BRAF.mat \
 --samplesLabel "H3K27ac BRAF" "H3K27ac CDKN2A+BRAF" "H3K27ac CDKN2A" "H3K27ac NHM" \
-out /root/ong_dukenus/ATAC-SEQ/heatmap/H3K27ac_NHM_BRAF.pdf

plotHeatmap --xAxisLabel "" --yAxisLabel "" --refPointLabel "TSS" --colorMap Oranges \
-m /root/vivek/chip-seq/heatmap/H3K27me3_NHM_BRAF.mat \
 --samplesLabel "H3K27me3 BRAF" "H3K27me3 CDKN2A+BRAF" "H3K27me3 CDKN2A" "H3K27me3 NHM" \
-out /root/ong_dukenus/ATAC-SEQ/heatmap/H3K27me3_NHM_BRAF.pdf

plotHeatmap --xAxisLabel "" --yAxisLabel "" --refPointLabel "TSS" --colorMap Greens \
-m /root/vivek/chip-seq/heatmap/H3K4me3_NHM_BRAF.mat \
 --samplesLabel "H3K4me3 BRAF" "H3K4me3 CDKN2A+BRAF" "H3K4me3 CDKN2A" "H3K4me3 NHM" \
-out /root/ong_dukenus/ATAC-SEQ/heatmap/H3K4me3_NHM_BRAF.pdf

plotHeatmap --xAxisLabel "" --yAxisLabel "" --refPointLabel "TSS" --colorMap Reds \
-m /root/vivek/chip-seq/heatmap/H3K9me3_NHM_BRAF.mat \
 --samplesLabel "H3K9me3 BRAF" "H3K9me3 CDKN2A+BRAF" "H3K9me3 CDKN2A" "H3K9me3 NHM" \
-out /root/ong_dukenus/ATAC-SEQ/heatmap/H3K9me3_NHM_BRAF.pdf

#############################################################################################################

plotHeatmap --xAxisLabel "" --yAxisLabel "" --refPointLabel "TSS" --colorMap Blues \
-m /root/vivek/chip-seq/heatmap/H3K27ac_NHM_CDKN2A.mat \
 --samplesLabel "H3K27ac BRAF" "H3K27ac CDKN2A+BRAF" "H3K27ac CDKN2A" "H3K27ac NHM" \
-out /root/ong_dukenus/ATAC-SEQ/heatmap/H3K27ac_NHM_CDKN2A.pdf

plotHeatmap --xAxisLabel "" --yAxisLabel "" --refPointLabel "TSS" --colorMap Oranges \
-m /root/vivek/chip-seq/heatmap/H3K27me3_NHM_CDKN2A.mat \
 --samplesLabel "H3K27me3 BRAF" "H3K27me3 CDKN2A+BRAF" "H3K27me3 CDKN2A" "H3K27me3 NHM" \
-out /root/ong_dukenus/ATAC-SEQ/heatmap/H3K27me3_NHM_CDKN2A.pdf

plotHeatmap --xAxisLabel "" --yAxisLabel "" --refPointLabel "TSS" --colorMap Greens \
-m /root/vivek/chip-seq/heatmap/H3K4me3_NHM_CDKN2A.mat \
 --samplesLabel "H3K4me3 BRAF" "H3K4me3 CDKN2A+BRAF" "H3K4me3 CDKN2A" "H3K4me3 NHM" \
-out /root/ong_dukenus/ATAC-SEQ/heatmap/H3K4me3_NHM_CDKN2A.pdf

plotHeatmap --xAxisLabel "" --yAxisLabel "" --refPointLabel "TSS" --colorMap Reds \
-m /root/vivek/chip-seq/heatmap/H3K9me3_NHM_CDKN2A.mat \
 --samplesLabel "H3K9me3 BRAF" "H3K9me3 CDKN2A+BRAF" "H3K9me3 CDKN2A" "H3K9me3 NHM" \
-out /root/ong_dukenus/ATAC-SEQ/heatmap/H3K9me3_NHM_CDKN2A.pdf
